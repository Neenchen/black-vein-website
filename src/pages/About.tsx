...
const serverFeatureGroups: ServerFeatureGroup[] = [
  { title: "Start your wipe", icon: castleHeartIcon, intro: "Everything you need in your first minutes on Black Vein.", points: ["The whole map is revealed immediately.", "Waygates are available once you have discovered them.", "Starter missions are skipped - begin by placing your Castle Heart."] },
  ...
  { title: "World changes", icon: stygianAltarIcon, intro: "Extra movement, farming routes and competitive points of interest.", points: ["Rifts are active daily from 10:00 until 01:00 GMT+2.", "Vanilla caves now lead to small farming-resource rooms.", "Caves can be used from both sides.", "Some multi-entrance plots have a blocked entrance for fairer plot balance."] },
];
